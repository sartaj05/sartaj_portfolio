...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get("sartaj.ahamad0502@gmail.com")
EMAIL_HOST_PASSWORD = os.environ.get("nvto nhdv dtir gofs")
DEFAULT_FROM_EMAIL = os.environ.get("sartaj.ahamad0502@gmail.com")
